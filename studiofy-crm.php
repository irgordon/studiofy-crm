...
define('STUDIOFY_VERSION', '2.2.37');
...
function studiofy_check_dependencies(): void {
    ...
    add_action('admin_notices', function() {
        ...
        // FIX: Check if $screen is not null before accessing properties to prevent null deprecation warnings
        if ($screen && isset($screen->parent_file) && 'plugins.php' === $screen->parent_file) return;
