...
class GalleryShortcode {
    ...
    // ... (enqueue_assets, render same as v2.2.38) ...
    ...
    public function handle_submit(): void {
        ...
        // 3. Kanban Integration (FIXED: Fallback to ANY project if 'in_progress' fails)
        if ($gallery->customer_id) {
            ...
            if ($project_row) {
                ...
                $wpdb->insert($wpdb->prefix.'studiofy_tasks', [
                    ...
                    'status' => 'todo', // Force to 'todo' column
                    'created_at' => current_time('mysql')
                ]);
            }
        }
