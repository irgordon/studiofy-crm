    ...
    protected function register_controls(): void {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#2271b1',
                'selectors' => [
                    '{{WRAPPER}} .studiofy-calendar-day.selected' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .studiofy-time-slot:hover' => 'border-color: {{VALUE}}; color: {{VALUE}}',
                    '{{WRAPPER}} .studiofy-time-slot.selected' => 'background-color: {{VALUE}}; border-color: {{VALUE}}; color: #fff',
                ],
            ]
        );
