...
class InvoiceController {
    ...
    // ... (render_page, render_list, render_items_page, render_builder, handle_save, handle_save_item, handle_delete_item same as v2.2.49) ...
    ...
    public function handle_print(): void {
        ...
        $business_logo_url = !empty($branding['business_logo']) ? (string)$branding['business_logo'] : ''; // This would be the URL to image if set
        // NEW: Get Email
