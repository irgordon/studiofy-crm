...
class InvoiceController {
            ...
            foreach ($rows as $r) {
                ...
                echo "<tr>
                    ...
                    <td>
                        ...
                        <a href='" . esc_url($email_url) . "' class='button button-small' onclick='return confirm(\"Email invoice link?\")'>Send</a>
    ...
    public function handle_save(): void {
        ...
        // Service Fee Calculation (3% if checked)
        $service_fee = 0.00;
