...
class InvoiceController {
    ...
    // ... (render_page, render_list, render_items_page, render_builder, handle_save, handle_save_item, handle_delete_item match v2.2.49 exactly) ...
    ...
    public function handle_print(): void {
        ...
        // FIX: Removed Dompdf. Using Browser Native Print.
        ob_start();
        include STUDIOFY_PATH . 'templates/admin/invoice-template.php';
        $html = ob_get_clean();
        
        // Inject JS for auto-print
