...
use Studiofy\Security\Encryption; // Added for customer data decryption
...
class InvoiceController {
    ...
    // ... (render_page, render_list, render_items_page same as v2.2.34) ...
    ...
    private function render_builder(): void {
        ...
        // Initialize default empty object for new invoices
        if (!$inv) {
            $inv = new \stdClass();
            $inv->id = 0; 
        ...
        // FIX: Initialize Customer Object to prevent "property on null" errors
        $customer = new \stdClass();
        $customer->name = '';
        $customer->company = '';
        $customer->address = '';
        
        // If invoice has a customer, fetch details to populate the preview
        ...
        // FIX: Assign variable name expected by template
        $invoice = $inv; 
    ...
    // ... (handle_save_item, handle_delete_item, handle_print same as v2.2.34) ...
