                    ...
                    <ul class="studiofy-folder-list">
                        <?php foreach($galleries as $g): ?>
                            <li class="folder-item" data-id="<?php echo $g->id; ?>">
                                <span class="dashicons <?php echo $g->wp_page_id ? 'dashicons-lock' : 'dashicons-hidden'; ?>"></span> 
        ...
        <div id="modal-new-gallery" class="studiofy-modal-overlay studiofy-hidden">
            <div class="studiofy-modal">
                ...
                <form method="post" action="<?php echo admin_url('admin-post.php'); ?>" class="studiofy-modal-body">
                    ...
                    <div class="studiofy-form-actions"><button type="button" class="button close-modal">Cancel</button><button type="submit" class="button button-primary">Create & Create Page</button></div>
                </form>
            </div>
        </div>
