...
class CustomerController {
    ...
    private function render_list(): void {
        ...
        $where = '';
        if ($search) {
            $where = $wpdb->prepare("WHERE first_name LIKE %s OR last_name LIKE %s OR email LIKE %s", "%$search%", "%$search%", "%$search%");
        }
        ...
        <div class="wrap">
            ...
            <a href="?page=studiofy-customers&action=new" class="page-title-action">Add New</a>
            <hr class="wp-header-end">
            
            <form method="post" action="<?php echo admin_url('admin-post.php'); ?>">
                <input type="hidden" name="action" value="studiofy_bulk_customer">
                <?php wp_nonce_field('bulk_customer', 'studiofy_nonce'); ?>
                ...
                <div class="tablenav top">
                    ...
                    <div class="alignright">
                        ...
                        <button type="button" class="button" onclick="window.location.href='?page=studiofy-customers&s='+this.previousElementSibling.value">Search</button>
                    </div>
                </div>
                ...
                <table class="wp-list-table widefat fixed striped">
                    ...
                    <tbody>
                        ...
                        <?php else: foreach ($items as $item): 
                            $edit_url = "?page=studiofy-customers&action=edit&id={$item->id}";
                            $clone_url = "?page=studiofy-customers&action=clone&id={$item->id}";
                            $del_url = wp_nonce_url(admin_url('admin-post.php?action=studiofy_delete_customer&id=' . $item->id), 'delete_customer_' . $item->id);
                            $phone = $this->encryption->decrypt($item->phone);
                        ?>
                            <tr>
                                ...
                                <td class="has-row-actions column-primary">
                                    ...
                                    <div class="row-actions">
                                        ...
                                        <span class="clone"><a href="<?php echo $clone_url; ?>">Clone</a> | </span>
                                ...
                                <td>Projects: <?php echo $item->project_count; ?> | Invoices: <?php echo $item->invoice_count; ?></td>
                            </tr>
