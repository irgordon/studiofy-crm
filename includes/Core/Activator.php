...
class Activator {
    public static function activate(): void {
        ...
        $tables = [
            ...
            'studiofy_bookings' => "CREATE TABLE {$wpdb->prefix}studiofy_bookings (id mediumint(9) NOT NULL AUTO_INCREMENT, guest_name varchar(100) NULL, guest_email varchar(100) NULL, service_type varchar(100) NOT NULL, booking_date date NOT NULL, booking_time time NOT NULL, status varchar(20) DEFAULT 'pending' NOT NULL, created_at datetime DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY (id)) $charset_collate;",
