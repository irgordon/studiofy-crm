...
class Activator {
    public static function activate(): void {
        ...
        $tables = [
            ...
            'studiofy_galleries' => "CREATE TABLE {$wpdb->prefix}studiofy_galleries (
                id mediumint(9) NOT NULL AUTO_INCREMENT,
                title varchar(255) NOT NULL,
                customer_id mediumint(9) NULL,
                description longtext NULL,
                wp_page_id bigint(20) NULL, -- Linked WP Page
            ...
            'studiofy_gallery_files' => "CREATE TABLE {$wpdb->prefix}studiofy_gallery_files (
                ...
                meta_photographer varchar(100) NULL,
                meta_project varchar(100) NULL,
                is_watermarked boolean DEFAULT 0,
                created_at datetime DEFAULT CURRENT_TIMESTAMP NOT NULL,
                PRIMARY KEY (id)
            ) $charset_collate;",

            // Other tables retained for integrity
