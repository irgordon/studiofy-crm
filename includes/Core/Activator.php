...
class Activator {
    public static function activate(): void {
        ...
        $tables = [
            ...
            'studiofy_tasks' => "CREATE TABLE {$wpdb->prefix}studiofy_tasks (id mediumint(9) NOT NULL AUTO_INCREMENT, milestone_id mediumint(9) NOT NULL, title varchar(255) NOT NULL, priority varchar(20) DEFAULT 'Medium' NOT NULL, description longtext NULL, checklist_json longtext NULL, status varchar(20) DEFAULT 'pending', created_at datetime DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY (id)) $charset_collate;",
