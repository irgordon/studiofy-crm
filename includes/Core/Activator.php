...
class Activator {
    public static function activate(): void {
        ...
        $tables = [
            ...
            'studiofy_galleries' => "CREATE TABLE {$wpdb->prefix}studiofy_galleries (id mediumint(9) NOT NULL AUTO_INCREMENT, title varchar(255) NOT NULL, customer_id mediumint(9) NULL, status varchar(20) DEFAULT 'draft' NOT NULL, access_code varchar(50) NULL, created_at datetime DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY (id)) $charset_collate;",
            ...
            'studiofy_projects' => "CREATE TABLE {$wpdb->prefix}studiofy_projects (id mediumint(9) NOT NULL AUTO_INCREMENT, customer_id mediumint(9) NOT NULL, title varchar(255) NOT NULL, status varchar(50) DEFAULT 'todo' NOT NULL, budget decimal(10,2) NULL, notes longtext NULL, created_at datetime DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY (id)) $charset_collate;",
            'studiofy_contracts' => "CREATE TABLE {$wpdb->prefix}studiofy_contracts (id mediumint(9) NOT NULL AUTO_INCREMENT, customer_id mediumint(9) NOT NULL, project_id mediumint(9) NULL, title varchar(255) NOT NULL, amount decimal(10,2) DEFAULT 0.00, start_date date NULL, end_date date NULL, body_content longtext NOT NULL, signature_data longtext NULL, signed_name varchar(100) NULL, status varchar(20) DEFAULT 'draft' NOT NULL, created_at datetime DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY (id)) $charset_collate;",
