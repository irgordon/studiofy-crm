        ...
        <div class="studiofy-panel">
            <div class="studiofy-form-row">
                <div class="studiofy-col">
                    ...
                    <input type="text" name="title" value="<?php echo esc_attr($data->title); ?>" class="widefat" required <?php echo $readonly; ?> placeholder="e.g. Wedding Agreement">
                </div>
                <div class="studiofy-col">
                    <label>Client</label>
                ...
                <div class="studiofy-col">
                    ...
                    <input type="text" name="service_type" list="service_options" value="<?php echo esc_attr($data->service_type); ?>" class="widefat" placeholder="Type or select..." <?php echo $readonly; ?>>
                ...
                <div class="studiofy-col">
                    ...
                    <select name="payment_status" class="widefat" <?php echo $readonly; ?>>
                 ...
                 <div class="studiofy-col">
                    ...
                    <select name="contract_status" class="widefat" <?php echo $readonly; ?>>
        ...
        <div class="studiofy-panel">
            ...
            <table class="wp-list-table widefat fixed striped">
                ...
                <tbody id="billing-items-body">
                    ...
                    <tr>
                        <td><input type="text" name="items[<?php echo $idx; ?>][name]" value="<?php echo esc_attr($item['desc']); ?>" class="widefat" <?php echo $readonly; ?>></td>
                        <td><input type="number" step="0.01" name="items[<?php echo $idx; ?>][rate]" value="<?php echo esc_attr($item['rate']); ?>" class="widefat item-rate" <?php echo $readonly; ?>></td>
                        <td><input type="number" name="items[<?php echo $idx; ?>][qty]" value="<?php echo esc_attr($item['qty']); ?>" class="widefat item-qty" <?php echo $readonly; ?>></td>
                        <td><span class="item-total">$0.00</span></td>
                        <td>
                            <?php if(!$is_locked): ?>
                            <button type="button" class="button-link-delete remove-row">&times;</button>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
            ...
            <div class="billing-totals">
                ...
                <div id="discount-row" style="display:none;" class="total-row">
                    <span>Discount (%): <input type="number" step="1" name="discount_percent" id="discount_percent" value="0" style="width:60px;" <?php echo $readonly; ?>></span> 
                ...
                <div id="deposit-row" style="display:none; border-top:1px dashed #ccc; padding-top:10px; margin-top:10px;">
                    <label>Deposit Amount: $<input type="number" step="0.01" name="deposit_amount" value="<?php echo esc_attr($data->deposit_amount); ?>" style="width:100px;" <?php echo $readonly; ?>></label>
                    <label style="margin-left:10px;">Final Due: <input type="date" name="final_due_date" value="<?php echo esc_attr($data->due_date); ?>" <?php echo $readonly; ?>></label>
                </div>
        ...
        <div class="studiofy-panel">
            ...
            <div class="payment-methods-grid">
                ...
                foreach($methods as $m) {
                    ...
                    echo "<label class='pm-btn'><input type='checkbox' name='payment_methods[]' value='$m' $checked $readonly> $m</label>";
                }
                ?>
            </div>
            ...
            <div style="margin-top:20px;">
                <label>Memo</label>
                <textarea name="memo" class="widefat" rows="2" <?php echo $readonly; ?>><?php echo esc_textarea($data->memo); ?></textarea>
            </div>
        </div>
